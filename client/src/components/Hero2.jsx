...
export function MinimalAnimatedHeroReact() {
 ...
 const scrollToSection = (sectionId) => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* Keyframes for the subtle pulses */}
      <style>
        {`
        @keyframes flow {
          0%, 100% {
        ...
        @keyframes pulse1 { 0%,100%{opacity:.4;transform:scale(.8)} 50%{opacity:1;transform:scale(1.2)} }
        @keyframes pulse2 { 0%,100%{opacity:.3;transform:scale(.9)} 50%{opacity:1;transform:scale(1.1)} }
        @keyframes pulse3 { 0%,100%{opacity:.5;transform:scale(.7)} 50%{opacity:1;transform:scale(1.3)} }
        `}
      </style>
      ...
      <main className="relative z-10 flex flex-col items-start justify-start sm:justify-center min-h-[calc(100vh-80px)] px-4 sm:px-6 lg:px-12 max-w-6xl pt-4 sm:-mt-12 lg:-mt-24 pl-6 sm:pl-12 lg:pl-20">
        ...
        <p className="text-white/70 text-sm sm:text-base md:text-sm lg:text-2xl mb-6 sm:mb-8 max-w-2xl text-pretty">
          Computer Science student with a strong grasp of data structures, algorithms, and OOP principles.
...
export default MinimalAnimatedHeroReact
